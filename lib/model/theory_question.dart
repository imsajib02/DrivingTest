...
class TheoryQuestion {
  ...
  TheoryQuestion.fromMap(Map<String, dynamic> json) {
    ...
    correctAnswer = json[DbHelper.TABLE_QUESTIONS_COLUMNS[14]] == null ? 0 : json[DbHelper.TABLE_QUESTIONS_COLUMNS[14]];
  ...
  toMap() {
    ...
    DbHelper.TABLE_QUESTIONS_COLUMNS[14] : correctAnswer == null ? 0 : correctAnswer,
