              ...
              GestureDetector(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        _highwayCodeViewModel.allCategoryListBangla[index]) : "",
                          ...
                          style: GoogleFonts.poppins(
                            textStyle: Theme.of(context).textTheme.headline5.copyWith(fontWeight: FontWeight.w300),
                          ),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      flex: 1,
                      child: Icon(Icons.arrow_forward_ios, size: 7.69 * SizeConfig.imageSizeMultiplier, color: Colors.blue[600],),
                    ),
                  ],
                ),
                onTap: () {
