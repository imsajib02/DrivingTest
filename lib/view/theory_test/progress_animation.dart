                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Flexible(
                        flex: 1,
                        child: Icon(Icons.thumb_up, color: Colors.green, size: 4.61 * SizeConfig.imageSizeMultiplier,
                        ),
                      ),
                ...
                Container(
                  child: Row(
                    children: <Widget>[
                      ...
                      Flexible(
                        flex: 1,
                        child: Icon(Icons.thumb_down, color: Colors.green, size: 4.61 * SizeConfig.imageSizeMultiplier,
                        ),
                      ),
