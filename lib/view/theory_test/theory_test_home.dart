...
final List<String> _categories = <String>['Practise All Questions', 'Mock Test', 'Search Questions', 'My Questions', 'Progress Monitor', 'Stopping Distances', 'Help & Support', 'Offers & Rewards'];
final List<String> _categoriesBangla = <String>['সমস্ত প্রশ্ন অনুশীলন', 'মক পরীক্ষা', 'প্রশ্ন অনুসন্ধান', 'আমার প্রশ্নগুলো', 'অগ্রগতি মনিটর', 'থামার দূরত্ব ', 'সাহায্য সহযোগীতা', 'অফার এবং পুরষ্কার'];
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return GestureDetector(
          child: Container(
              ...
              padding: EdgeInsets.all(1.25 * SizeConfig.heightSizeMultiplier),
              margin: EdgeInsets.only(bottom: 5 * SizeConfig.heightSizeMultiplier, left: 4.10 * SizeConfig.widthSizeMultiplier, right: 4.10 * SizeConfig.widthSizeMultiplier),
              decoration: BoxDecoration(
                color: Colors.green,
                shape: BoxShape.rectangle,
                borderRadius: BorderRadius.all(Radius.circular(5.0)),
