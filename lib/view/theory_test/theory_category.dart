...
final List<Widget> _categoryIcons = <Widget>[Icon(Icons.menu, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,), Icon(Icons.timer, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,), Icon(Icons.vpn_key, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,),
  Icon(Icons.tag_faces, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,), Icon(Icons.assignment, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,), Image.asset(Images.errorIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,),
  Icon(Icons.traffic, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,), Image.asset(Images.emergencyIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,), Image.asset(Images.busIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,),
  Image.asset(Images.steeringIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,), Image.asset(Images.roadIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,), Image.asset(Images.bookIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,),
  Image.asset(Images.clockIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,), Image.asset(Images.screwdriverIcon, color: Colors.green[400], height: 4.375 * SizeConfig.heightSizeMultiplier, width: 8.97 * SizeConfig.widthSizeMultiplier,), Icon(Icons.people, size: 6.5 * SizeConfig.imageSizeMultiplier, color: Colors.green,),
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        alignment: Alignment.centerLeft,
                                        child: Text(_settingsViewModel.isEnglish ? Constants.categories[index] : Constants.categoriesBangla[index],
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: _categorySelection[index] ? Colors.green : Colors.white,
