          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  Provider.of<SettingsViewModel>(context, listen: false).playSound();
                  _questionSearchViewModel.alterLanguage(interface: widget._questionView.questionSearchInterface);
                },
              ),
            ),
            ...
            Expanded(
              ...
              child: Align(
                alignment: Alignment.bottomCenter,
                child: Text(_settingsViewModel.isEnglish ? AppLocalization.of(context).getTranslatedValue("letter_q") + _questionSearchViewModel.number.toString()
                    + AppLocalization.of(context).getTranslatedValue("of") + _questionSearchViewModel.filterList.list.length.toString() :
                _questionSearchViewModel.totalSize + AppLocalization.of(context).getTranslatedValue("of") +
                    AppLocalization.of(context).getTranslatedValue("letter_q") + _questionSearchViewModel.stringNumber,
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  Colors.white : Colors.green) : Colors.transparent,
              ...
              Container(
                ...
                ((index+1) == _questionSearchViewModel.filterList.list[_questionSearchViewModel.number-1].correctAnswer ? Icon(Icons.check_circle_outline,
                  size: 6.41 * SizeConfig.imageSizeMultiplier, color: Colors.green,) :
                Container()) : Container(),
              ),
            ],
          );
          ...
          Expanded(
              ...
              child: GestureDetector(
                child: Container(
                  child: Icon(
                    Icons.favorite,
                    color: _questionSearchViewModel.number > 0 ? (_questionSearchViewModel.filterList.list[_questionSearchViewModel.number-1].isMarkedFavourite ? Colors.green : Colors.black) :
                    Colors.black,
                    size: 8.97 * SizeConfig.imageSizeMultiplier,
                  ),
                ),
