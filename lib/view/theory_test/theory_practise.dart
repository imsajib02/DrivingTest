          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  Provider.of<SettingsViewModel>(context, listen: false).playSound();
                  _answerViewModel.alterLanguage();
                },
              ),
            ),
            ...
            Expanded(
              ...
              child: Align(
                alignment: Alignment.bottomCenter,
                child: Text(_settingsViewModel.isEnglish ? AppLocalization.of(context).getTranslatedValue("letter_q") + _answerViewModel.number.toString() +
                    AppLocalization.of(context).getTranslatedValue("of") + _answerViewModel.testQuestionList.list.length.toString() :
                _answerViewModel.totalQuestion + AppLocalization.of(context).getTranslatedValue("of") +
                    AppLocalization.of(context).getTranslatedValue("letter_q") + _answerViewModel.stringNumber,
            ...
            child: Stack(
              children: <Widget>[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    (((index + 1) == _answerViewModel.testQuestionList.list[_answerViewModel.number-1].optionAnswered) ||
                        ((index + 1) == _answerViewModel.testQuestionList.list[_answerViewModel.number-1].correctAnswer) ? Colors.white : Colors.green) :
                    (_answerViewModel.testQuestionList.list[_answerViewModel.number-1].optionAnswered != 0 &&
                        ((index + 1) == _answerViewModel.testQuestionList.list[_answerViewModel.number-1].optionAnswered) ? Colors.white : Colors.green)) : Colors.transparent,
                ...
                Container(
                  ...
                  (((index + 1) == _answerViewModel.testQuestionList.list[_answerViewModel.number-1].correctAnswer) ?
                  Icon(Icons.check_circle_outline, size: 6.41 * SizeConfig.imageSizeMultiplier, color: Colors.green,) :
                  Container())) : Container(),
                ),
              ],
            ),
          ...
          Expanded(
              ...
              child: GestureDetector(
                child: Container(
                  child: Icon(
                    Icons.favorite,
                    color: _answerViewModel.number > 0 ? (_answerViewModel.testQuestionList.list[_answerViewModel.number-1].isMarkedFavourite ? Colors.green : Colors.black) : Colors.black,
                    size: 8.97 * SizeConfig.imageSizeMultiplier,
                  ),
                ),
                onTap: () {
              ...
              child: GestureDetector(
                child: Container(
                  ...
                  Text(AppLocalization.of(context).getTranslatedValue("finish"), style: Theme.of(context).textTheme.headline6.copyWith(
                      color: _answerViewModel.testQuestionList.list[_answerViewModel.number-1].optionAnswered != 0 ? Colors.green : Colors.grey),) :
                  Icon(Icons.arrow_forward_ios, color: Colors.black, size: 12.82 * SizeConfig.imageSizeMultiplier,)),
                ),
  ...
  void _saveOptionAnswered(int choice) {
    ...
    for(int i=0; i<4; i++) {
      ...
      if(i == choice) {
        ...
        if(i+1 == _answerViewModel.testQuestionList.list[_answerViewModel.number - 1].correctAnswer) {
          isCorrect = true;
        }
      }
    }
