...
class FindRoadSign extends StatefulWidget {

  @override
  _FindRoadSignState createState() => _FindRoadSignState();
}


class _FindRoadSignState extends State<FindRoadSign> implements HighwayCodeInterface {
    ...
    return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(
              flex: 5,
              child: Text(AppLocalization.of(context).getTranslatedValue("choose_sign"),
    ...
    return NotificationListener<OverscrollIndicatorNotification>(
      ...
      child: mounted ? Container(
        ...
        child: GridView.builder(
          ...
          itemCount: _highwayCodeViewModel.roadSignList.list.length,
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return _highwayCodeViewModel.roadSignList.list[index].hasImage ? GestureDetector(
              onTap: () {
                Provider.of<SettingsViewModel>(context, listen: false).playSound();
                _highwayCodeViewModel.onRoadSignSelected(index, _highwayCodeInterface, false);
              },
              child: Image.memory(_highwayCodeViewModel.roadSignList.list[index].image),
            ) : Container();
          },
        ),
