...
class Constants {
  ...
  static const List<String> categoriesBangla = ['সব বিভাগ', 'সতর্কতা', 'মনোভাব', 'নথি', 'বিপদসচেতনতা', 'রাস্তা ও ট্র্যাফিকের চিহ্ন', 'ঘটনা, দুর্ঘটনা ও জরুরী অবস্থা',
    'অন্যান্য ধরণের যানবাহন', 'যানবাহন পরিচালনা', 'মোটরওয়ে বিধি', 'রাস্তার আইন', 'সুরক্ষা মার্জিন', 'সুরক্ষা এবং আপনার যানবাহন', 'ক্ষতিগ্রস্থ রোড ব্যবহারকারীরা', 'যানবাহন লোড হচ্ছে'];
  ...
  static const List<List<String>> roadSignSubCategoryList = [["Signs on motorways - blue backgrounds", "Signs on primary routes - green backgrounds​",
    ...
    ["Across the carriageway", "Along the carriageway", "Along the edge of the carriagewa", "Loading restrictions on roads other than Red Routes", "Other road markings"],
    ["General guidance", "Motorcycle licence requirements"], [], [], ["​Stop", "​To beckon traffic on", "Arm signals to persons controlling traffic",
  ...
  static const List<List<String>> roadSignSubCategoryListBangla = [["মোটরওয়েতে চিহ্ন - নীল পটভূমি", "প্রাথমিক রুটে চিহ্ন - সবুজ পটভূমি​",
    ...
    ["সাধারণ নির্দেশিকা", "মোটরসাইকেলের লাইসেন্সের প্রয়োজনীয়তা"], [], [], ["​থামুন", "​ট্র্যাফিক চালু করতে", "ট্র্যাফিক নিয়ন্ত্রণকারী ব্যক্তিদের কাছে আর্ম সিগন্যাল",
