            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _theoryProgressViewModel.currentIndex == TheoryProgressViewModel.all ? Colors.green : Colors.black45,
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _theoryProgressViewModel.currentIndex == TheoryProgressViewModel.correct ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                margin: EdgeInsets.only(left: .51 * SizeConfig.widthSizeMultiplier, right: .76 * SizeConfig.widthSizeMultiplier),
                decoration: BoxDecoration(
                  color: _theoryProgressViewModel.currentIndex == TheoryProgressViewModel.incorrect ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _theoryProgressViewModel.currentIndex == TheoryProgressViewModel.flagged ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  (_theoryProgressViewModel.practisePerformanceList.list[widget._index].testQuestionList.list[index].isAnsweredCorrectly ? Colors.green : Colors.red) :
                  (_theoryProgressViewModel.mockPerformanceList.list[widget._index].testQuestionList.list[index].isAnsweredCorrectly ? Colors.green : Colors.red),
