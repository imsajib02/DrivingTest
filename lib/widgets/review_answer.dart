            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _testResultViewModel.currentIndex == TestResultViewModel.all ? Colors.green : Colors.black45,
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _testResultViewModel.currentIndex == TestResultViewModel.correct ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                margin: EdgeInsets.only(left: .51 * SizeConfig.widthSizeMultiplier, right: .76 * SizeConfig.widthSizeMultiplier),
                decoration: BoxDecoration(
                  color: _testResultViewModel.currentIndex == TestResultViewModel.incorrect ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
          ...
          Expanded(
            ...
            child: GestureDetector(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _testResultViewModel.currentIndex == TestResultViewModel.flagged ? Colors.green : Colors.black45,
                  borderRadius: BorderRadius.circular(5),
                ),
          ...
          return Stack(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: widget._resultModel.questionList.list[index].isAnsweredCorrectly ? Colors.green : Colors.red,
